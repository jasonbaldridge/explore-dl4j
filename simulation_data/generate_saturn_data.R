...
#plot(out$features, col=mycols[out$labels+1])
...
# Create eval data. Make sigma bigger to make it a bit more interesting.
numEval = 10000/2
eval_out = sim_saturn_data(numEval, numDimensions, c(5, 10), sigma = 2.0)
